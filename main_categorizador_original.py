...
def main():
    ...
    # =========================================================
    # FASE 1: EXTRACCION DE DATOS (CPU)
    # =========================================================
    print("\n>>> FASE 1: EXTRACCION (CPU)...")
    ...
    shutil.copy(pdf_actual, EXT_INPUT / pdf_actual.name)

    # Se agrega la ruta del extractor al sistema
    ...
    try:
        ...
        print(f"Error durante la ejecucion del extractor: {e}")
        return
    ...
    # ---------------------------------------------------------
    # CORRECCIÓN CRITICA: REACTIVAR GPU
    # ---------------------------------------------------------
    if 'CUDA_VISIBLE_DEVICES' in os.environ:
        del os.environ['CUDA_VISIBLE_DEVICES']
        print("\n[SISTEMA] GPU Reactivada para las fases de modelos.")
    ...
    for ruta_json in rutas_jsons_procesar:
        ...
        # Ejecuta la logica del modelo pasando el nombre del archivo (NUEVA FIRMA)
